...
setup_stack (struct intr_frame *if_) {
	...
	// printf("alloc_success: %d\n", alloc_success);
	// if (alloc_success) {
	// 	vm_claim_page(stack_bottom);
	// 	if_->rsp = USER_STACK;
	// 	// off_t pos = file_tell (file);
	// 	// struct file *file = filesys_open (file_name);
	// 	// char* buffer = palloc_get_page (PAL_ASSERT);
	// 	// hex_dump (pos, buffer, n, true); 
	// 	// hex_dump(if_->rsp , if_->rsp , if_->rsp - 100, true);
	// 	return true;
...
// 	// 	struct aux_struct *aux = (struct aux_struct*)malloc(sizeof(struct aux_struct));
// 	// 	aux->vmfile = file;
// 	// 	aux->ofs = ofs;
...
// 	/* TODO: Map the stak on stack_bottom and claim the page immediately.
// 	 * TODO: If success, set the rsp accordingly.
// 	 * TODO: You should mark the page is stack. */
// 	/* TODO: Your code goes here */
